...
//document.write(poemArray.join("\n"));
      ...
      //removewords = removewords.concat(newWords);//.replace(/,/g, " ");
      //removewords = removewords;
      poem = poem.replace(newWords, " ");
      //mylikedwords = mylikedwords.concat(arrayWords);
      //addpoem = poem.concat(mylikedwords).replace(/,/g, " ");//.replace(/\./g, " ");
 ...
 //     document.write(text)
    ...
    this.shareEmail = function(e) {
      var text = self.htmlSelection.replace(/<p[^>]*>/ig,'\n').replace(/<\/p>|  /ig,'').trim();
      var email = {};
      //var words = document.getElementById("poem").value;
    ...
    this.render = function() {
      var popoverHTML =  '<div class="selectionSharer" id="selectionSharerPopover" style="position:absolute;">'
                       ...
                       + '    <ul>'
                       + '      <li><a class="action tweet" href="" title="Like this!" target="_blank">Tweet</a></li>'
                       + '      <li><a class="action facebook" href="" title="Dislike this!" target="_blank">Facebook</a></li>'
